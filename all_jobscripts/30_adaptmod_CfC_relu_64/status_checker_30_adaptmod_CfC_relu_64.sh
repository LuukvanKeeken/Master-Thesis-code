...
jobids_file="jobids_30_adaptmod_CfC_relu_64.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/30_adaptmod_CfC_relu_64/"
dest_dir="/projects/s3512290/LTC_A2C/30_adaptmod_CfC_relu_64/"
