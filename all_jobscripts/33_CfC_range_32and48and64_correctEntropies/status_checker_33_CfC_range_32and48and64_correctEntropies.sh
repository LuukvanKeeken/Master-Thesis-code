...
jobids_file="jobids_33_CfC_range_32and48and64_correctEntropies.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/33_CfC_range_32and48and64_correctEntropies/"
dest_dir="/projects/s3512290/LTC_A2C/33_CfC_range_32and48and64_correctEntropies/"
