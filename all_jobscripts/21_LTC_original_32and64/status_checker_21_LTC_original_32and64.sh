...
jobids_file="jobids_21_LTC_original_32and64.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/21_LTC_original_32and64/"
dest_dir="/projects/s3512290/LTC_A2C/21_LTC_original_32and64/"
