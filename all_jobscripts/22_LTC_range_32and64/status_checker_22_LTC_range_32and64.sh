...
jobids_file="jobids_22_LTC_range_32and64.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/22_LTC_range_32and64/"
dest_dir="/projects/s3512290/LTC_A2C/22_LTC_range_32and64/"
