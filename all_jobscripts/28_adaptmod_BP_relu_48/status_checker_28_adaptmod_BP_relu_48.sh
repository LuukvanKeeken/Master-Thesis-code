...
jobids_file="jobids_28_adaptmod_BP_relu_48.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/BP_A2C/28_adaptmod_BP_relu_48/"
dest_dir="/projects/s3512290/BP_A2C/28_adaptmod_BP_relu_48/"
