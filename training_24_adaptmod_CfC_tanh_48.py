...
phase_1_dir = "CfC_a2c_result_46020_202453_learningrate_0.001_numneurons_48_encoutact_tanh_neuromod_network_dims_3_192_96_48"

if result_id == -1:
    dirs = os.listdir(f'Master_Thesis_Code/{top_dir}/24_adaptmod_CfC_tanh_48/')
...
results_dir = f"Master_Thesis_Code/{top_dir}/24_adaptmod_CfC_tanh_48/adaptation_module_{adapt_mod_type}_result_{result_id}_{str(d.year) + str(d.month) + str(d.day)}_BP_a2c_result_2169_202448_numneuronsadaptmod_{num_neurons_adaptation}_lradaptmod_{lr_adapt_mod}_wdadaptmod_{wd_adapt_mod}"
os.mkdir(results_dir)


weights_0 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_0.pt', map_location=torch.device(device))
weights_1 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_1.pt', map_location=torch.device(device))
weights_2 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_2.pt', map_location=torch.device(device))
weights_3 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_3.pt', map_location=torch.device(device))
weights_4 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_4.pt', map_location=torch.device(device))
weights_5 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_5.pt', map_location=torch.device(device))
weights_6 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_6.pt', map_location=torch.device(device))
weights_7 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_7.pt', map_location=torch.device(device))
weights_8 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_8.pt', map_location=torch.device(device))
weights_9 = torch.load(f'Master_Thesis_Code/{top_dir}/7_NMCfC_tanh_48/{phase_1_dir}/checkpoint_{neuron_type}_A2C_9.pt', map_location=torch.device(device))
