...
jobids_file="jobids_25_adaptmod_ONMCfC_relu_48.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/25_adaptmod_ONMCfC_relu_48/"
dest_dir="/projects/s3512290/LTC_A2C/25_adaptmod_ONMCfC_relu_48/"
