...
jobids_file="jobids_18_MLP_original_32and64.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/BP_A2C/18_MLP_original_32and64/"
dest_dir="/projects/s3512290/BP_A2C/18_MLP_original_32and64/"
