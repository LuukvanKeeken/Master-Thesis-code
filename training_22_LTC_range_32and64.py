...
if result_id == -1:
    dirs = os.listdir('Master_Thesis_Code/LTC_A2C/22_LTC_range_32and64/')
...
d = date.today()
result_dir = f'Master_Thesis_Code/LTC_A2C/22_LTC_range_32and64/{network_type}_a2c_result_' + str(result_id) + f'_{str(d.year)+str(d.month)+str(d.day)}_learningrate_{learning_rate}_selectiomethod_{selection_method}_trainingmethod_{training_method}_numneurons_{num_neurons}'
if network_type == "CfC":
