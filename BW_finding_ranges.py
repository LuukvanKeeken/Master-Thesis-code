...
def main():
    with torch.no_grad():
        ...
        percentages_rld = [0.0625, 0.075, 0.0875, 0.1, 3.5, 3.625, 3.75, 3.875, 4.0, 4.125, 4.25, 4.375, 4.5, 4.625, 4.75, 4.875, 5.0]
        ...
        all_percentages = [percentages_rld]
        all_results_means = []
        all_results_stds = []
        num_episodes = 150
