...
jobids_file="jobids_6_MLP_original_48.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/BP_A2C/6_MLP_original_48/"
dest_dir="/projects/s3512290/BP_A2C/6_MLP_original_48/"
