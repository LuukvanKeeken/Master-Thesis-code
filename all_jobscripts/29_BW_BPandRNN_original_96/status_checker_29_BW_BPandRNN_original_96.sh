...
jobids_file="jobids_29_BW_BPandRNN_original_96.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/BP_A2C/29_BW_BPandRNN_original_96/"
dest_dir="/projects/s3512290/BP_A2C/29_BW_BPandRNN_original_96/"
