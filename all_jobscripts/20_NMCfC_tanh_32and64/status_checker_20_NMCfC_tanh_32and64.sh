...
jobids_file="jobids_20_NMCfC_tanh_32and64.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/20_NMCfC_tanh_32and64/"
dest_dir="/projects/s3512290/LTC_A2C/20_NMCfC_tanh_32and64/"
