...
policy_weights_1 = torch.load(f'Master_Thesis_Code/{top_dir}/{batch_dir}/Standard_RNN_a2c_result_4000000_2024718_entropycoef_0.001_valuepredcoef_0.001_learningrate_0.0001_numtrainepisodes_1000000_selectionmethod_range_trainingmethod_quarter_range_numneurons_96/checkpoint_BP_A2C_0.pt', map_location=torch.device(device))
policy_weights_2 = torch.load(f'Master_Thesis_Code/{top_dir}/{batch_dir}/Standard_RNN_a2c_result_4000001_2024718_entropycoef_0.001_valuepredcoef_0.001_learningrate_0.0001_numtrainepisodes_1000000_selectionmethod_range_trainingmethod_quarter_range_numneurons_96/checkpoint_BP_A2C_0.pt', map_location=torch.device(device))
policy_weights_3 = torch.load(f'Master_Thesis_Code/{top_dir}/{batch_dir}/Standard_RNN_a2c_result_4000002_2024718_entropycoef_0.001_valuepredcoef_0.001_learningrate_0.0001_numtrainepisodes_1000000_selectionmethod_range_trainingmethod_quarter_range_numneurons_96/checkpoint_BP_A2C_0.pt', map_location=torch.device(device))
policy_weights_4 = torch.load(f'Master_Thesis_Code/{top_dir}/{batch_dir}/Standard_RNN_a2c_result_4000003_2024718_entropycoef_0.001_valuepredcoef_0.001_learningrate_0.0001_numtrainepisodes_1000000_selectionmethod_range_trainingmethod_quarter_range_numneurons_96/checkpoint_BP_A2C_0.pt', map_location=torch.device(device))
policy_weights_5 = torch.load(f'Master_Thesis_Code/{top_dir}/{batch_dir}/Standard_RNN_a2c_result_4000004_2024718_entropycoef_0.001_valuepredcoef_0.001_learningrate_0.0001_numtrainepisodes_1000000_selectionmethod_range_trainingmethod_quarter_range_numneurons_96/checkpoint_BP_A2C_0.pt', map_location=torch.device(device))
policy_weights_6 = torch.load(f'Master_Thesis_Code/{top_dir}/{batch_dir}/Standard_RNN_a2c_result_4000005_2024718_entropycoef_0.001_valuepredcoef_0.001_learningrate_0.0001_numtrainepisodes_1000000_selectionmethod_range_trainingmethod_quarter_range_numneurons_96/checkpoint_BP_A2C_0.pt', map_location=torch.device(device))
policy_weights_7 = torch.load(f'Master_Thesis_Code/{top_dir}/{batch_dir}/Standard_RNN_a2c_result_4000006_2024718_entropycoef_0.001_valuepredcoef_0.001_learningrate_0.0001_numtrainepisodes_1000000_selectionmethod_range_trainingmethod_quarter_range_numneurons_96/checkpoint_BP_A2C_0.pt', map_location=torch.device(device))
policy_weights_8 = torch.load(f'Master_Thesis_Code/{top_dir}/{batch_dir}/Standard_RNN_a2c_result_4000007_2024718_entropycoef_0.001_valuepredcoef_0.001_learningrate_0.0001_numtrainepisodes_1000000_selectionmethod_range_trainingmethod_quarter_range_numneurons_96/checkpoint_BP_A2C_0.pt', map_location=torch.device(device))
policy_weights_9 = torch.load(f'Master_Thesis_Code/{top_dir}/{batch_dir}/Standard_RNN_a2c_result_4000008_2024718_entropycoef_0.001_valuepredcoef_0.001_learningrate_0.0001_numtrainepisodes_1000000_selectionmethod_range_trainingmethod_quarter_range_numneurons_96/checkpoint_BP_A2C_0.pt', map_location=torch.device(device))
...
with torch.no_grad():
    ...
    with open(f"Master_Thesis_Code/{top_dir}/{batch_dir}/remaining_stdRNN/train_val_test.txt", "w") as f:
