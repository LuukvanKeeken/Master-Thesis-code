...
if result_id == -1:
    ...
    dirs = os.listdir('Master_Thesis_Code/BP_A2C/5_MLP_range_48/')
...
d = date.today()
result_dir = f'Master_Thesis_Code/BP_A2C/5_MLP_range_48/{network_type}_a2c_result_' + str(result_id) + "_{}_entropycoef_{}_valuepredcoef_{}_\
