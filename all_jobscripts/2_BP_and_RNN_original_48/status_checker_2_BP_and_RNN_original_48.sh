...
jobids_file="jobids_2_BP_and_RNN_original_48.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/BP_A2C/2_BP_and_RNN_original_48/"
dest_dir="/projects/s3512290/BP_A2C/2_BP_and_RNN_original_48/"
