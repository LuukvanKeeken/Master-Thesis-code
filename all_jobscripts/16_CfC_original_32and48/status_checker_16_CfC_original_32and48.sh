...
jobids_file="jobids_16_CfC_original_32and48.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/16_CfC_original_32and48/"
dest_dir="/projects/s3512290/LTC_A2C/16_CfC_original_32and48/"
