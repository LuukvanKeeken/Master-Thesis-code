...
jobids_file="jobids_26_adaptmod_ONMCfC_tanh_48.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/26_adaptmod_ONMCfC_tanh_48/"
dest_dir="/projects/s3512290/LTC_A2C/26_adaptmod_ONMCfC_tanh_48/"
