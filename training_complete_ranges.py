...
for i_run in range(num_models):
    ...
    for section in range(0, int(num_training_episodes/training_eps_per_section)):
        ...
        if section == 0:
            smoothed_scores, scores, best_average, best_average_after, training_total_rewards, training_losses, validation_total_rewards, validation_losses = agent.train_agent_discrete_testing_ranges(training_eps_per_section, section, randomization_params = randomization_params)
        else:
            smoothed_scores, scores, best_average, best_average_after, training_total_rewards, training_losses, validation_total_rewards, validation_losses = agent.train_agent_discrete_testing_ranges(training_eps_per_section, section, randomization_params = randomization_params, best_average=best_average_all[i_run], best_average_after=best_average_after_all[i_run])
