...
jobids_file="jobids_32_adaptmod_ONMCfC_tanh_64.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/32_adaptmod_ONMCfC_tanh_64/"
dest_dir="/projects/s3512290/LTC_A2C/32_adaptmod_ONMCfC_tanh_64/"
