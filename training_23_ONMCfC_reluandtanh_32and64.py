...
if result_id == -1:
    dirs = os.listdir(f'Master_Thesis_Code/{top_dir}/23_ONMCfC_reluandtanh_32and64/')
...
d = date.today()
result_dir = f'Master_Thesis_Code/{top_dir}/23_ONMCfC_reluandtanh_32and64/{neuron_type}_a2c_result_' + str(result_id) + f'_{str(d.year)+str(d.month)+str(d.day)}_learningrate_{learning_rate}_numneurons_{num_neurons}_encoutact_{args.encoder_output_activation}'
# if neuron_type == "CfC":
