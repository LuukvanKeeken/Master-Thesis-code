        ...
        for learning_rate in learning_rates:
            for entropy_coef in entropy_coefs:
                for value_coef in value_coefs:
                    ...
                    if neuron_type == "CfC":
                        results_dir = f'CfC_a2c_result_{results_id}_{date}_learningrate_{learning_rate}_selectiomethod_{selection_method}_trainingmethod_{training_method}_numneurons_{num_neurons}_mode_pure'
