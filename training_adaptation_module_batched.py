...
parser.add_argument('--num_training_eps', type=int, default=15000, help="Number of episodes to train the adaptation module")
...
phase_1_dir = "CfC_a2c_result_20078_2024426_learningrate_0.0005_numneurons_48_encoutact_relu_neuromod_network_dims_3_256_128_48"
...
results_dir = f"Master_Thesis_Code/{top_dir}/adaptation_module/training_results/adaptation_module_{adapt_mod_type}_result_{result_id}_{str(d.year) + str(d.month) + str(d.day)}_BP_a2c_result_2169_202448_numneuronsadaptmod_{num_neurons_adaptation}_lradaptmod_{lr_adapt_mod}_wdadaptmod_{wd_adapt_mod}"
