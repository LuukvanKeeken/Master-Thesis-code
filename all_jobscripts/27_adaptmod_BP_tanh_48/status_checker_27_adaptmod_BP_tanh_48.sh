...
jobids_file="jobids_27_adaptmod_BP_tanh_48.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/BP_A2C/27_adaptmod_BP_tanh_48/"
dest_dir="/projects/s3512290/BP_A2C/27_adaptmod_BP_tanh_48/"
