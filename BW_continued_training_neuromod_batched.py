...
parser.add_argument('--value_pred_coef', type=float, default=1.0, help="The coefficient for the value prediction loss")
...
parser.add_argument('--additional_seed', type=int, default=2, help='Additional number to add to the seed')
...
d = date.today()
# result_dir = f'Master_Thesis_Code/{top_dir}/bipedal_walker/Continued_NMBP_{neuron_type}_a2c_result_' + str(result_id) + f'_{str(d.year)+str(d.month)+str(d.day)}_learningrate_{learning_rate}_numneurons_{num_neurons}_encoutact_{args.encoder_output_activation}'
# if neuron_type == "CfC":
...
result_dir = "Master_Thesis_Code/BP_A2C/bipedal_walker/Continued_BP_a2c_result_4400002_2024718_learningrate_0.0001_numneurons_96_encoutact_tanh_neuromod_network_dims_11_256_128_96"
os.mkdir(result_dir)
print('Created Directory {} to store the results in'.format(result_dir))

weights = torch.load("Master_Thesis_Code/BP_A2C/bipedal_walker/BP_a2c_result_4400002_2024718_learningrate_0.0001_numneurons_96_encoutact_tanh_neuromod_network_dims_11_256_128_96/checkpoint_BP_A2C_0.pt")
