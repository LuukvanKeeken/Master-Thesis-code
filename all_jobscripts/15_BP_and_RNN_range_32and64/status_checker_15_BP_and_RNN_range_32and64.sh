...
jobids_file="jobids_15_BP_and_RNN_range_32and64.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/BP_A2C/15_BP_and_RNN_range_32and64/"
dest_dir="/projects/s3512290/BP_A2C/15_BP_and_RNN_range_32and64/"
