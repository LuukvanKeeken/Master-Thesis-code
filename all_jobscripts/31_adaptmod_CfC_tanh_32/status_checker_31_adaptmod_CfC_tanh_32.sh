...
jobids_file="jobids_31_adaptmod_CfC_tanh_32.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/LTC_A2C/31_adaptmod_CfC_tanh_32/"
dest_dir="/projects/s3512290/LTC_A2C/31_adaptmod_CfC_tanh_32/"
