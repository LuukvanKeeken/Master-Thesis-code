...
jobids_file="jobids_14_NMBP_reluandtanh_32and64.txt"

# Directory to move
src_dir="$HOME/Thesis/Master_Thesis_Code/BP_A2C/14_NMBP_reluandtanh_32and64/"
dest_dir="/projects/s3512290/BP_A2C/14_NMBP_reluandtanh_32and64/"
