...
MLPLIBDQN_evaluation_statistic = np.load(f"../BP_A2C/evaluation_results/Standard_DQN_MLPLIBRARY_10models/{modified_parameter}/second_10/{statistic}s.npy")
MLPLIBDQN_evaluation_std = np.load(f"../BP_A2C/evaluation_results/Standard_DQN_MLPLIBRARY_10models/{modified_parameter}/second_10/stddevs.npy")
# MLPLIBDQN_evaluation_percentages = np.load(f"../BP_A2C/evaluation_results/Standard_DQN_MLPLIBRARY_10models/{modified_parameter}/percentages.npy")
MLPLIBDQN_evaluation_percentages = BP_evaluation_percentages
# MLPLIBDQN_evaluation_percentages = (MLPLIBDQN_evaluation_percentages*100)-100
if statistic == "mean":
    ax.errorbar(MLPLIBDQN_evaluation_percentages[start:end], MLPLIBDQN_evaluation_statistic[start:end], MLPLIBDQN_evaluation_std[start:end], capsize=5, label = "MLPLIBDQN")
elif statistic == "median":
    ax.plot(MLPLIBDQN_evaluation_percentages[start:end], MLPLIBDQN_evaluation_statistic[start:end], label = "MLPLIBDQN")
