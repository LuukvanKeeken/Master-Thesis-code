        ...
        for learning_rate in learning_rates:
            for entropy_coef in entropy_coefs:
                for value_coef in value_coefs:
                    ...
                    try:
                        with open(f"Master_Thesis_Code/{top_dir}/6_MLP_original_48/{results_dir}/best_average_after.txt", "r") as file:
                        ...
                        files = os.listdir(f"Master_Thesis_Code/{top_dir}/6_MLP_original_48/{results_dir}")
                        num_files = len(files)
                        if num_files <= 5:
